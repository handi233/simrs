...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2025 at 03:38 PM
...
INSERT INTO `icd9` (`Id`, `kd`, `nama`) VALUES
...
INSERT INTO `icd10` (`id`, `kd`, `nama`) VALUES
(1, 'A01', 'TBC'),
(2, 'A00', 'Cholera');
...
INSERT INTO `pasien` (`no_rkm_medis`, `nama`, `no_ktp`, `jk`, `tmp_lahir`, `tgl_lahir`, `nm_ibu`, `alamat`, `gol_darah`, `pekerjaan`, `stts`, `agama`, `tgl_daftar`, `no_tlp`, `umur`, `pnd`, `keluarga`, `namakeluarga`, `kd_pj`, `no_peserta`, `kd_kel`, `kd_kec`, `kd_kab`, `pekerjaanpj`, `alamatpj`, `kelurahanpj`, `kecamatanpj`, `kabupatenpj`, `perusahaan_pasien`, `suku_bangsa`, `bahasa_pasien`, `cacat_fisik`, `email`, `nip`, `kd_prop`, `propinsipj`) VALUES
('0001', 'hasbi', 0, 'L', '', '0000-00-00', '', '', 'B', '', '', 'ISLAM', '0000-00-00', '', '', 'TK', 'IBU', '', 'UM', '', '', 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', 0, ''),
('0002', 'dika', 2147483647, 'P', 'KEDIRI', '2025-07-04', '-', '-', 'B', '-', '', '-', '2025-07-03', '', '', '-', '', '', '-', '', '', 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', 0, ''),
('0003', 'DEKA', 2147483647, 'L', '', '0000-00-00', '', 'PARE', '-', '', 'B', '-', '0000-00-00', '', '', 'TK', 'IBU', '', '', '', '', 0, 0, '', '', '', '', '', '', 0, 0, 0, '', '', 0, '');
...
CREATE TABLE `rajal` (
  ...
  `kd_pj` varchar(20) NOT NULL,
  `kd_stts` varchar(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `rajal` (`no_rkm_medis`, `tgl_periksa`, `jam_periksa`, `kd_dokter`, `kd_pj`, `kd_stts`) VALUES
('0001', '2025-07-01', '19:55:04', 'Dr. Mutya', 'BPJS', 'LAMA');
...
INSERT INTO `status` (`id_stts`, `nama`, `harga`) VALUES
(1, 'LAMA', '5000'),
(2, 'BARU', '10000');
...
('admin', '$2y$10$BdNklxz1DAbrdib7xokd6e3iC.r7LQ8iRTbUKOO.p2XR495UCiqae', NULL, NULL, NULL);
...
ALTER TABLE `rajal`
  ADD KEY `no_rkm_medis` (`no_rkm_medis`),
  ADD KEY `kd_stts` (`kd_stts`),
  ADD KEY `rajal_ibfk_3` (`kd_pj`),
  ADD KEY `rajal_ibfk_2` (`kd_dokter`);
...
ALTER TABLE `rajal`
  ...
  ADD CONSTRAINT `rajal_ibfk_2` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`nama_dokter`) ON UPDATE CASCADE,
  ADD CONSTRAINT `rajal_ibfk_3` FOREIGN KEY (`kd_pj`) REFERENCES `penjab` (`kd_pj`) ON UPDATE CASCADE,
  ADD CONSTRAINT `rajal_ibfk_4` FOREIGN KEY (`kd_stts`) REFERENCES `status` (`nama`) ON UPDATE CASCADE;
