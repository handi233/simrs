...
if (isset($_POST['simpan'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO igd (`no_rkm_medis`,`tgl_inap`,`jam_inap`) VALUES (?, ?,?)");
...
// Query pertama
$result = $conn->query("SELECT * FROM igd");
...
$conn = new mysqli("localhost", "root", "", "simrs");
$result2 = $conn->query("SELECT * FROM igd");
$conn->close();
