...
if (isset($_POST['simpan'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO icd9 (`kd`, `nama`) VALUES (?, ?)");

    if ($stmt === false) {
        die("Prepare failed: " . $conn->error);
    }

    $stmt->bind_param("ss", $kd,  $nama);
...
<div id="id01" class="modal">
  <form class="modal-content animate" action="../../modul/icd9/index.php" method="post">
    <div class="container">
   <div class="inputform">
    
<div>

 <input type="text"  name="kd"  placeholder="Kode" required>
   </div>
 <input type="text"name="nama" placeholder="Nama Prosedure">
...
// Query pertama
$result = $conn->query("SELECT * FROM icd9");
...
$conn = new mysqli("localhost", "root", "", "simrs");
$result2 = $conn->query("SELECT * FROM icd9");
$conn->close();
