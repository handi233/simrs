...
<body>
  <div>
  <h1 class="h1title">SATU SEHAT LOKASI</h1>
</div>
...
// Query pertama
$result = $conn->query("SELECT * FROM satu_sehat_lokasi");
...
$conn = new mysqli("localhost", "root", "", "simrs");
$result2 = $conn->query("SELECT * FROM satu_sehat_lokasi");
$conn->close();
