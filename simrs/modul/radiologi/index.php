...
$query = "SELECT no_rkm_medis FROM radiologi ORDER BY no_rkm_medis DESC LIMIT 1";
...
if (isset($_POST['simpan'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO radiologi (`no_rkm_medis`,`tgl_periksa`,`jam_periksa`,`nama_dokter`,`nama_pj`) VALUES (?, ?,?,?,?)");
...
<div id="id01" class="modal">
  <form class="modal-content animate" action="../../modul/radiologi/index.php" method="post">
    <div class="container">
   <div class="inputform">
...
<label>Tgl Periksa</label>
 ...
 <label class="mt-3">Jam Periksa</label>
...
// Query pertama
$result = $conn->query("SELECT * FROM radiologi");
...
$conn = new mysqli("localhost", "root", "", "simrs");
$result2 = $conn->query("SELECT * FROM radiologi");
$conn->close();
