...
if (isset($_POST['simpan'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO laborat (`no_rkm_medis`,`tgl_periksa`,`jam_periksa`,`nama_dokter`,`nama_pj`,`hasil_lab`) VALUES (?, ?,?,?,?,?)");

    if ($stmt === false) {
        die("Prepare failed: " . $conn->error);
    }

    $stmt->bind_param("ssssss", $no_rkm_medis,  $tgl_periksa,$jam_periksa,$nama_dokter,$nama_pj,$hasil_lab);
